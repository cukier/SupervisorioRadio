...
public class Status extends JFrame {
	...
	public Status() {
		...
		setTitle("Supervis�rio Piv� Krebsfer");
		...
		btnStart = new JButton("Lendo piv�...");
	...
	public void updateStatus(int anguloAtual, boolean sentido, int estado,
		...
		btnSentdido.setText(sentido ? "Avan�o" : "Revers�o");
		mostrador.setEstado(estado);
		switch (estado) {
		case 0: // parado
		case 5: // alarmeSeguraca
			btnStart.setText("Iniciar Irriga��o");
			btnSentdido.setEnabled(true);
			btnLamina.setEnabled(true);
			break;
		default:
		case 7: // irrigando
			btnStart.setText("Parar Irriga��o");
			btnSentdido.setEnabled(false);
			btnLamina.setEnabled(false);
			break;
		}
